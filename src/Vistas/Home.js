    ...
    <>
      ...
      <div className="cont_modal_home" ref={modal}>
        <form
          ...
          className="form_modal_crear_paciente"
          id="home_modal"
        >
          ...
          <div className="box_crear_paciente">
            ...
            <div>
              <label htmlFor="validationServer01">Sexo</label>
              <select
                required
                onChange={formik.handleChange}
                name="Sex"
            ...
            <div>
              <label htmlFor="validationServer02">Nombre De Los Padres </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="validationServer02">Teléfono del padre</label>
              <input
                type="text"
                id="validationServer02"
                onChange={formik.handleChange}
            ...
            <div>
              <label htmlFor="validationServer02">Teléfono de la madre</label>
              <input
                type="text"
                id="validationServer02"
                onChange={formik.handleChange}
            ...
            <div>
              <label htmlFor="validationServer02">Fecha de nacimiento</label>
              <input
                type="date"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Edad</label>
              <input
                type="number"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Centro de Estudios</label>
              <input
                type="text"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Curso</label>
              <input
                type="text"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Recomendaciones </label>
              <input
                type="text"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Quien refiere</label>
              <input
                type="text"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Configuración familiar</label>
              <input
                type="text"
                id="validationServer02"
                required
            ...
            <div>
              <label htmlFor="validationServer02">Terapias o servicio </label>
              <input
                type="text"
                id="validationServer02"
                required
                ...
                value={
                  formik.values.TherapiesOrServiceYouWillReceiveAtTheCenter
                }
              />
            </div>
            <div>
              <label htmlFor="validationServer02">Diagnóstico </label>
              <input
                type="text"
                id="validationServer02"
                required
